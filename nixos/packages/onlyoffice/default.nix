...
let
  ...
  src = fetchurl {
    url = "https://github.com/ONLYOFFICE/DesktopEditors/releases/download/ONLYOFFICE-DesktopEditors-${version}/DesktopEditors-x86_64.AppImage";
    sha256 = "sha256:19sjmp8qd2l0q6s9n7919d8wfzg9nfdw16k5dad5ai1373fdwgas";
  };
