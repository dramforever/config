...
rustPlatform.buildRustPackage (finalAttrs: {
  pname = "halloy";
  version = "2026.5-unstable-20260405";

  src = fetchFromGitHub {
    owner = "squidowl";
    repo = "halloy";
    rev = "98c16af48d4813a882d2199bcc008975dffb5815";
    hash = "sha256-SXxIPu0/W7H+w/08ofOvIwyBw3T8vwJMuZ3lSqJiDw4=";
  };

  cargoHash = "sha256-jEdOeGL3rVj+Kl+O5u5q7OzZ5CtGwhKYqFBCtEEKQrw=";
